...
- **Q:** 没有go环境无法使用最新功能
 ...
 A： 可以使用Dockerfile构建一个容器镜像，假设容器镜像名称为kamalyes/gst:v1.0.0，docker build -t kamalyes/gst:v1.0.0 .
     启动一个名称为gst的容器docker run -d --name=gst kamalyes/gst:v1.0.0
	 开始压测 docker exec -it gst  /service/bin/gst -c 10 -n 10 -u www.baidu.com
